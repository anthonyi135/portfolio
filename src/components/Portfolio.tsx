...
const projects: Project[] = [
  ...
  },
  {
    ...
    category: 'video',
    videoSrc: 'https://drive.google.com/file/d/1Wzu_zDcmiEgkZlZfbpDz-SoiweC56A-Q/view?usp=sharing',
    poster: '',
    role: 'Director of Photography, Editor',
  ...
  },
  {
    ...
    category: 'video',
    videoSrc: 'https://www.youtube.com/embed/uFE9vXopZqs', // Use your Google Drive link if hosted on Drive
    poster: '/tony_youtube.png',
